...
late final LocalStorage storage = new LocalStorage('old');

class DioFactory  implements Disposable {
  static  DioFactory _singleton = DioFactory._instance();
  ...
  static void initialiseHeaders(String token) {
    ...
    _singleton = DioFactory._instance();
