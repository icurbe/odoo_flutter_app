...
showWarning(message) {
  showSnackBar(backgroundColor: Colors.deepOrange, message: message);
}

showSuccess(message) {
  showSnackBar(backgroundColor: Colors.lightGreen, message: message);
}
...
showSessionDialog() {
  Get.dialog(
    AlertDialog(
      ...
      content: Text(
        "¡Lo siento! su sesión ha caducado, inicie sesión de nuevo",
